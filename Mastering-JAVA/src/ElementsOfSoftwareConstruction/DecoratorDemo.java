...
public class DecoratorDemo {
    public static void main(String[] args){
        MyPizza basicPizza = new TomatoSauce(new Ham((new Cheese(new PlainPizza()))));
...
class Ham extends ToppingDecorator{
    public Ham(MyPizza newPizza){ super(newPizza);}

    public String ingredients(){return tempPizza.ingredients()+", ham";}

    public double getCost(){return  tempPizza.getCost()+0.40;}
}