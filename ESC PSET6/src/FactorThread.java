...
public class FactorThread {    
	public static BigInteger onefactor = new BigInteger("0");
	...
	public static void main(String[] args) throws Exception {
		...
		BigInteger theother = n.divide(FactorThread.onefactor);
		System.out.println("Factors are: " + FactorThread.onefactor + ", " + theother);
